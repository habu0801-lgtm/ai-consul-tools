...
サービスの対象・対応地域・実績の公開表記は https://shiroji.jp/ を正本とし、READMEを同期する。2026-09-12確認：対象の従業員数とシフトの具体的な店舗数は掲載せず、対応地域は東京・福岡を中心に全国出張対応、オンラインも全国対応とする。店舗数の非掲載は稼働終了を意味しない。

2026-09-13更新：公開ブランド表記はShiroji。紹介文では企業規模を限定せず、シフトの操作主体は運営管理者と表記。GitHub本文に本名・区名を重複掲載せず、運営者情報は公式サイトへ案内する。2026年7月開業は維持。
